...
export const DEAL_TAB_STRINGS = {
  teklif: {
    ...
    emptyFilter: "Seçili görünüm ve filtrelerle eşleşen teklif yok.",
    columnHeader: "Teklif",
  ...
  randevu: {
    ...
    emptyFilter: "Seçili görünüm ve filtrelerle eşleşen randevu yok.",
  ...
  uyelik: {
    ...
    emptyFilter: "Seçili görünüm ve filtrelerle eşleşen üyelik yok.",
    columnHeader: "Üyelik",
  ...
  rezervasyon: {
    ...
    emptyFilter: "Seçili görünüm ve filtrelerle eşleşen rezervasyon yok.",
